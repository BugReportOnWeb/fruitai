        ...
        <div className="bg-[#EAEFEB] rounded-2xl p-3.5 flex gap-5 font-bold">
            ...
            <div className="w-full flex flex-col justify-between gap-3">
                ...
                <div className='flex gap-3'>
                    <button className='border w-full p-2 rounded-xl bg-blue-500'>Update</button>
                    <button type='button' className='border w-full p-2 rounded-xl bg-red-500' onClick={() => deleteFaq(faq.id)}>Delete</button>
                </div>
            </div>
        </div>
    )
